...
# https://github.com/adieyal/sd-dynamic-prompts/blob/main/tests/conftest.py#L58
...
class MockProcessing:
    ...
    all_hr_negative_prompts: list[str] = dataclasses.field(
    ...
    def set_negative_prompt_for_test(self, negative_prompt):
        ...
        self.all_negative_prompts = (
            [negative_prompt] * self.n_iter * self.batch_size
        )
